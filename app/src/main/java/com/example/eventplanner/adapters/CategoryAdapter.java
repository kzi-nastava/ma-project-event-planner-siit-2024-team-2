...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.ViewHolder> {
    private List<ServiceProductCategory> items;
    private OnItemClickListener listener;

    public interface OnItemClickListener {
        void onEditClick(ServiceProductCategory dto);
        void onDeleteClick(ServiceProductCategory dto);
    }

    public CategoryAdapter(List<ServiceProductCategory> items, OnItemClickListener listener) {
        this.items = items;
    ...
    public void onBindViewHolder(@NonNull CategoryAdapter.ViewHolder holder, int position) {
        ServiceProductCategory dto = items.get(position);
